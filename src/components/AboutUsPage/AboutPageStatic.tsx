...
export const teamDetails: TeamImage[] = [
	{
		...
		icon: <CarIcon />,
		quote: "Keeping your engine in top shape is what I do best.",
	},
	{
		key: 2,
		empImage:
		...
		designation: "AUTO BODY SPECIALIST",
		empName: "SARAH JONES",
		icon: <CarIcon />,
	...
	},
	{
		...
		designation: "TIRE EXPERT",
		empName: "DAVID WILLIAMS",
		icon: <CarIcon />,
		quote: "A good set of tires is the foundation of a smooth ride.",
	},
	{
		key: 4,
		empImage:
